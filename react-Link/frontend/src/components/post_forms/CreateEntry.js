    ...
    <Card className={classes.cardStyle}>
      ...
      <CardActions disableSpacing>
        <Fab variant="extended" className={classes.extendedIcon}>
          <Image value={props.data.image} onChange={props.handleChange} />
          Upload Photo
        </Fab>
        <Fab variant="extended" className={classes.extendedIcon}>
          <Movie value={props.data.video} onChange={props.handleChange} />
          Upload video
        </Fab>
        <IconButton
...
let GROUPS = ["Deppe Fam", "Dog Appreciation", "Tea Chest"];
...
const SelectGroups = (props) => {
  ...
  const group_create_func = GROUPS.map((item) => {
    return (
      <FormControlLabel
        value={item}
        control={<Checkbox checked={item} onChange={props.handleChange} />}
        label={item}
      />
    );
  });
  ...
  return (
    <FormControl component="fieldset">
      ...
      <RadioGroup aria-label="Groups" height="100" width="100">
    ...
    <React.Fragment>
      ...
      <main className={classes.content}>
        <main className={classes.toolbar}>
          <EntryCard data={data} handler={handleChange} />
        </main>
        <main className={classes.toolbar} margin="20" padding="50px">
          <Box mx="auto" p={5}>
            <SelectGroups checked={data} onChange={handleChange} />
            <Button
              type="submit"
              variant="outlined"
              color="primary"
